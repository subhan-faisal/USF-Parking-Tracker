        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coordinates_Lat = table.Column<double>(type: "float", nullable: true),
                    Coordinates_Lng = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingEvents_ParkingLots_ParkingLotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingEvents_ParkingLotId",
                table: "ParkingEvents",
                column: "ParkingLotId");
        }
